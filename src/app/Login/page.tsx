...
const LoginPage = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // Check if email and password match with environment variables
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <input
              ...
              required
              autoComplete="email" // Add autocomplete for email field
        ...
        <div className="mb-6">
          ...
          <div className="relative">
            <input
              ...
              required
              autoComplete="current-password" // Add autocomplete for password field
              className="w-full p-2 pl-10 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500"
            />
